/**
 * Test script to check API endpoints from outside the container
 */
...
function testEndpoint(path) {
  return new Promise((resolve, reject) => {
    ...
    const req = http.request(options, res => {
      ...
      console.log(`Headers for ${path}:`, res.headers);
...
async function runTests() {
  try {
    console.log('Testing API endpoints from outside the container...');
